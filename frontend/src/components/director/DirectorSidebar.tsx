...
export default function DirectorSidebar() {
  ...
  /*
   * Empêcher le scroll de la page lorsque
  ...
  /*
   * Fermer automatiquement le menu lorsqu'on
   * repasse sur un écran desktop.
   */
  useEffect(() => {
    ...
    <>
      ...
      >
        ...
        <div className="relative flex h-full min-h-0 flex-col">
          ...
          <nav className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 py-4 sm:py-5">
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        ...
                        {isActive && (
                          <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300 shadow-[0_0_10px_#22D3EE]" />
                        )}
                      </>
                    )}
                  </NavLink>
